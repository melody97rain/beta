...
echo -e   "  \e[$number (•2)\e[m \e[$below TROJAN XRAY & GO\e[m            \e[$number (•9)\e[m  \e[$below CHANGE PORT\e[m"
echo -e   "  \e[$number (•3)\e[m \e[$below OPENSSH & OPENVPN\e[m           \e[$number (•10)\e[m \e[$below CHECK RUNNING\e[m"
echo -e   "  \e[$number (•4)\e[m \e[$below PANEL SHADOWSOCKS\e[m           \e[$number (•11)\e[m \e[$below REBOOT VPS\e[m"
echo -e   "  \e[$number (•5)\e[m \e[$below PANEL NOOBZVPN\e[m              \e[$number (•12)\e[m \e[$below INFO ALL PORT\e[m"
echo -e   "  \e[$number (•6)\e[m \e[$below SYSTEM MENU\e[m                 \e[$number (•13)\e[m \e[$below CHECK DAILY BANDWIDTH\e[m"
echo -e   "  \e[$number (•7)\e[m \e[$below MENU THEMES\e[m                 \e[$number (•14)\e[m \e[$below CHECK MONTHLY BANDWIDTH\e[m"
echo -e   " \e[$line════════════════════════════════════════════════════════════\e[m"
